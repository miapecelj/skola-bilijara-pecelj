    ...
    <ul className="space-y-2">
      {items.map((item, i) => (
        <li key={i} className="flex items-start gap-2 text-zinc-300 text-sm leading-relaxed">
          <Trophy size={14} className="text-emerald-400 mt-0.5 shrink-0" />
          {item}
        </li>
      ))}
    </ul>
  ...
  return (
    <section id="about" className="bg-zinc-900 py-20 px-4 border-t border-zinc-800">
      <div className="max-w-5xl mx-auto space-y-20">
        ...
        {/* ── Filozofija ──────────────────────────────────── */}
        <div data-aos="fade-up">
          <div className="relative bg-zinc-950 border border-emerald-900/50 rounded-2xl p-6 md:p-8 overflow-hidden">
            {/* accent bar */}
            <div className="absolute left-0 top-0 bottom-0 w-1 bg-emerald-500 rounded-l-2xl" />
            <h2 className="text-2xl md:text-3xl font-bold text-emerald-400 mb-5">Filozofija</h2>
            <p className="text-zinc-300 leading-relaxed text-[15px]">
        ...
        {/* ── Postignuća ──────────────────────────────────── */}
        <div data-aos="fade-up">
          <h2 className="text-2xl md:text-3xl font-bold text-emerald-400 text-center mb-10">
            Postignuća
          </h2>
        ...
        <div data-aos="fade-up">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="bg-zinc-800/40 border border-zinc-800 rounded-2xl p-6">
              ...
              <div className="flex flex-wrap gap-2">
                {programLevels.map((l) => (
                  <span
                    key={l}
                    className="px-3 py-1.5 rounded-full bg-emerald-500/10 border border-emerald-500/25 text-emerald-300 text-sm font-medium"
                  >
                    {l}
                  </span>
                ))}
            ...
            <div className="bg-zinc-800/40 border border-zinc-800 rounded-2xl p-6">
              ...
              <div className="flex items-start gap-3">
                <Video size={18} className="text-emerald-400 mt-0.5 shrink-0" />
                <p className="text-zinc-300 text-sm leading-relaxed">
