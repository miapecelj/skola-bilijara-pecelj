    ...
    >
      ...
      <div className="relative z-10 text-center text-zinc-100 px-4 flex flex-col items-center gap-6">
        ...
        <button
          ...
          className="mt-2 px-8 py-3.5 rounded-xl bg-emerald-500 hover:bg-emerald-400 text-black font-bold text-base tracking-wide shadow-lg shadow-emerald-900/40 hover:shadow-emerald-900/60 transition-all duration-200 hover:-translate-y-0.5"
        >
          Zakažite čas
        </button>
      </div>
